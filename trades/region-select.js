...
const TRADE_TYPE_OPTIONS = [
  ...
  "Аренда, безвозмездное пользование, доверительное управление имуществом, иные договоры, предусматривающие переход прав в отношении государственного или муниципального имущества, продажа имущества ФГУП",
  "Реализация имущества, обращенного в собственность государства",
  "Комплексное развитие территорий",
  "Продажа права пользования участком недр",
  ...
  "Закрепление и предоставление доли квоты добычи крабов в инвестиционных целях",
  "Продажа объектов незавершенного строительства",
  "Закрепление долей квот добычи водных биоресурсов и/или право пользования водными биоресурсами",
  "Публичные торги по продаже земельных участков",
  "Купля-продажа природных алмазов специальных размеров",
  "Право пользования рыбоводным участком",
  "Право пользования рыболовным участком",
  "Право заключения предварительного договора поставки донного грунта",
  "Соглашение о государственно-частном партнерстве, соглашение о муниципально-частном партнерстве",
  "Водопользование",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initSelectGroup("[data-trade-type-select]", {
    prefix: "trade-type",
